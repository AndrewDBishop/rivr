...
/**
 * Creates {@link DialogueContext} based on the {@link HttpServletRequest HTTP request}, the
 * dialogue ID and the {@link DialogueChannel}.
 *
...
public interface DialogueContextFactory<C extends DialogueContext<I, O>, I extends InputTurn, O extends OutputTurn> {
  C createDialogueContext(HttpServletRequest request, String dialogueId,
      DialogueChannel<I, O> dialogueChannel, Logger logger);
}
