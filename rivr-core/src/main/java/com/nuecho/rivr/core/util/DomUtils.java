...
public final class DomUtils {
  ...
  public static void writeToOutputStream(Node node, OutputStream outputStream, Encoding encoding)
      throws IOException {
  ...
  private static LSSerializer getSerializer() {
    ...
    if (xmlSerializer.getDomConfig().canSetParameter(FORMAT_PRETTY_PRINT_DOM_CONFIG_PARAMETER,
        Boolean.TRUE)) {
      xmlSerializer.getDomConfig().setParameter(FORMAT_PRETTY_PRINT_DOM_CONFIG_PARAMETER,
          Boolean.TRUE);
    }
