...
/**
 * An {@link ObjectCall} is a {@link VoiceXmlOutputTurn} used to exploit platform-specific
 * functionality.
 *
 * @author Nu Echo Inc.
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml2.3.5">https://www.w3.org/TR/voicexml20/#dml2.3.5</a>
 */
public class ObjectCall extends VoiceXmlOutputTurn {
  ...
  /**
   * @param classId The URI specifying the location of the object's implementation.
   */
  ...
  /**
   * @param codeBase The base path used to resolve relative URIs specified by classid, data, and
   *        archive.
   */
  ...
  /**
   * @param codeType The content type of data expected when downloading the object specified by
   *        classid.
   */
  ...
  /**
   * @param archives A list of URIs for archives containing resources relevant to the object.
   */
  ...
  /**
   * @param parameters A list of parameters passed when invoking object. Not null.
   */
  ...
  /**
   * @param postObjectScript The ECMAScript script to execute after object invocation.
   */
  ...
  protected void fillVoiceXmlDocument(Document document, Element formElement,
    ...
    createScript(filledElement,
        RIVR_SCOPE_OBJECT + ".addValueResult(" + OBJECT_RESULT_VARIABLE_NAME + ");");
    createGotoSubmit(filledElement);
  }

  /**
   * {@link ObjectCall} parameter, can be created with a string value, a {@link JsonValue} or an
   * expression.
   */
  public static final class Parameter implements JsonSerializable {
    ...
    /**
     * @param valueType One of {@link ParameterValueType#data} or {@link ParameterValueType#ref}.
     *        Indicates to an object if the value associated with name is data or a URI.
    ...
    /**
     * @param type The media type of the result provided by a URI if the value type is
     *        {@link ParameterValueType#ref}. <code>null</code> to use the VoiceXML platform default
     */
  ...
  public boolean equals(Object obj) {
    ...
    if (mArchives == null) {
      if (other.mArchives != null)
        return false;
    } else if (!mArchives.equals(other.mArchives))
      return false;
    if (mClassId == null) {
      ...
      return false;
    if (mCodeBase == null) {
      if (other.mCodeBase != null)
        return false;
    } else if (!mCodeBase.equals(other.mCodeBase))
      return false;
    if (mCodeType == null) {
      if (other.mCodeType != null)
        return false;
    } else if (!mCodeType.equals(other.mCodeType))
      return false;
    if (mData == null) {
      if (other.mData != null)
        return false;
    ...
    if (mFetchConfiguration == null) {
      if (other.mFetchConfiguration != null)
        return false;
    } else if (!mFetchConfiguration.equals(other.mFetchConfiguration))
      return false;
    if (mParameters == null) {
    ...
    if (mPostObjectScript == null) {
      if (other.mPostObjectScript != null)
        return false;
    } else if (!mPostObjectScript.equals(other.mPostObjectScript))
      return false;
    if (mType == null) {
      if (other.mType != null)
        return false;
