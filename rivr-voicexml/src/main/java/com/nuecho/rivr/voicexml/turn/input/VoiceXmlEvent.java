 ...
 * @author Nu Echo Inc.
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml5.2.6">https://www.w3.org/TR/voicexml20/#dml5.2.6</a>
 */
public final class VoiceXmlEvent implements JsonSerializable {
  ...
  public static final String ERROR_UNSUPPORTED_TRANSFER_BRIDGE =
      "error.unsupported.transfer.bridge";
  public static final String ERROR_UNSUPPORTED_TRANSFER_CONSULTATION =
  ...
  public static boolean hasEvent(String prefix, Collection<? extends VoiceXmlEvent> events) {
    for (VoiceXmlEvent voiceXmlEvent : events) {
      if (voiceXmlEvent.isSubtypeOf(prefix))
        return true;
    }
    return false;
  }
