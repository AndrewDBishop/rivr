 ...
 * <p>
 * Parameters may be passed to the subdialogue and return values may be retrieved if the invoked
 * subdialogue ends with a <code>&lt;return&gt;</code> instruction.
 *
 * @author Nu Echo Inc.
 * @see Parameter
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml2.3.4">https://www.w3.org/TR/voicexml20/#dml2.3.4</a>
 */
public class SubdialogueCall extends VoiceXmlOutputTurn {
  ...
  protected void fillVoiceXmlDocument(Document document, Element formElement,
    ...
    createVarElement(filledElement, SUBDIALOGUE_RESULT_VARIABLE_NAME,
        "dialog." + SUBDIALOGUE_FORM_ITEM_NAME);
  ...
  public boolean equals(Object obj) {
    ...
    if (mParameters == null) {
      ...
      return false;
    if (mPostDialogueScript == null) {
      if (other.mPostDialogueScript != null)
        return false;
    } else if (!mPostDialogueScript.equals(other.mPostDialogueScript))
      return false;
    if (mSubmitParameters == null) {
      if (other.mSubmitParameters != null)
        return false;
    } else if (!mSubmitParameters.equals(other.mSubmitParameters))
      return false;
    if (mUri == null) {
      if (other.mUri != null)
        return false;
