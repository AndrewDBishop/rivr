...
/**
 * A {@link Message} is a {@link VoiceXmlOutputTurn} that plays a sequence of {@link AudioItem}.
 *
 * @author Nu Echo Inc.
 * @see AudioItem
 * @see <a href=
...
public class Message extends VoiceXmlOutputTurn {
  ...
  /**
   * @param language The language identifier (e.g. "en-US") for the message. <code>null</code> to
  ...
  public boolean equals(Object obj) {
    ...
    if (mAudioItems == null) {
      ...
      return false;
    if (mBargeIn == null) {
      if (other.mBargeIn != null)
        return false;
    } else if (!mBargeIn.equals(other.mBargeIn))
      return false;
    if (mLanguage == null) {
