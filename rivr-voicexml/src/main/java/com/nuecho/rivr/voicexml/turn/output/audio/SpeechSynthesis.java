...
/**
 * A {@link SpeechSynthesis} represents a text that will be spoken using a synthesis voice. It can
 * be either a string of text or a SSML document.
 *
 * @author Nu Echo Inc.
 * @see <a href=
 *      "https://www.w3.org/TR/speech-synthesis/">https://www.w3.org/TR/speech-synthesis/</a>
 */
public final class SpeechSynthesis extends AudioItem {
  ...
  public boolean equals(Object obj) {
    ...
    if (mDocumentFragment == null) {
      if (other.mDocumentFragment != null)
        return false;
    } else if (!mDocumentFragment.equals(other.mDocumentFragment))
      return false;
    if (mText == null) {
      if (other.mText != null)
        return false;
