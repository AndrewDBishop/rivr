 ...
 * @author NuEcho Inc.
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml2.3.7.2.2">https://www.w3.org/TR/voicexml20/#dml2.3.7.2.2</a>
 */
public class TransferStatus implements JsonSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (mStatusCode == null) {
      if (other.mStatusCode != null)
        return false;
    } else if (!mStatusCode.equals(other.mStatusCode))
      return false;
    return true;
  }
