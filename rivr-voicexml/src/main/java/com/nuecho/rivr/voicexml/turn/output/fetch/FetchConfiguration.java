...
public class FetchConfiguration implements JsonSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (mFetchHint != other.mFetchHint)
      return false;
    if (mMaxAge == null) {
      if (other.mMaxAge != null)
        return false;
    } else if (!mMaxAge.equals(other.mMaxAge))
      return false;
    if (mMaxStale == null) {
      if (other.mMaxStale != null)
        return false;
    } else if (!mMaxStale.equals(other.mMaxStale))
      return false;
    if (mTimeOut == null) {
      if (other.mTimeOut != null)
        return false;
    } else if (!mTimeOut.equals(other.mTimeOut))
      return false;
    return true;
  }
