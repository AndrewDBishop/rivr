...
/**
 * A {@link GrammarReference} represents an external grammar reachable with an URI.
 *
 * @author Nu Echo Inc.
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml3.1.1.2">https://www.w3.org/TR/voicexml20/#dml3.1.1.2</a>
 */
public final class GrammarReference extends GrammarItem {
  ...
  /**
   * @param fetchConfiguration The resource fetch configuration. <code>null</code> to use the
