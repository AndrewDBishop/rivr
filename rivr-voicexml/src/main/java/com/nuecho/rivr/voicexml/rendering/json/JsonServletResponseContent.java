...
public class JsonServletResponseContent implements ServletResponseContent {
  ...
  public JsonServletResponseContent(JsonStructure jsonData, JsonpMode jsonpMode,
  ...
  public String getContentType() {
    ...
    else if (mJsonpMode == JsonpMode.NORMAL)
      return JSON_MIME_TYPE;
    else if (mJsonpMode == JsonpMode.TEXTAREA)
      return HTML_MIME_TYPE;
    else
      throw new AssertionError("Unexpected JSONP mode: " + mJsonpMode);
  }
