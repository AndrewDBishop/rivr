...
/**
 * A {@link SpeechRecognition} represents the speech part of an interaction phase recognition
 * configuration. It is composed of a list of speech {@link GrammarItem} and optional properties
 * (complete timeout, incomplete timeout, max speech timeout, max nbest, confidence level, speed
...
public final class SpeechRecognition extends Recognition {
  ...
  /**
   * @param completeTimeout The required length of silence following user speech before the speech
   *        recognizer finalizes a complete result. <code>null</code> to use the VoiceXML platform
   *        default
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3.2">https://www.w3.org/TR/voicexml20/#dml6.3.2</a>
   */
  ...
  /**
   * @param incompleteTimeout The required length of silence following user speech after which a
   *        recognizer finalizes an incomplete result. <code>null</code> to use the VoiceXML
   *        platform default
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3.2">https://www.w3.org/TR/voicexml20/#dml6.3.2</a>
   */
  ...
  /**
   * @param maxSpeechTimeout The maximum duration of user speech. <code>null</code> to use the
  ...
  /**
   * @param maxNBest The maximum size of the recognition result. Must be a positive integer.
  ...
  /**
   * @param confidenceLevel The speech recognition confidence level. Results with confidence below
   *        this value will be rejected (nomatch). Value must be between 0.0 and
   *        1.0.<code>null</code> to use the VoiceXML platform default.
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3.2">https://www.w3.org/TR/voicexml20/#dml6.3.2</a>
   */
  ...
  /**
   * @param speedVersusAccuracy A hint specifying the desired balance between speed versus accuracy.
  ...
  /**
   * @param sensitivity Set the sensitivity level. A value of 1.0 means that it is highly sensitive
   *        to quiet input. A value of 0.0 means it is least sensitive to noise. <code>null</code>
  ...
  public boolean equals(Object obj) {
    ...
    if (mCompleteTimeout == null) {
      if (other.mCompleteTimeout != null)
        return false;
    } else if (!mCompleteTimeout.equals(other.mCompleteTimeout))
      return false;
    if (mConfidenceLevel == null) {
      if (other.mConfidenceLevel != null)
        return false;
    } else if (!mConfidenceLevel.equals(other.mConfidenceLevel))
      return false;
    if (mIncompleteTimeout == null) {
      if (other.mIncompleteTimeout != null)
        return false;
    } else if (!mIncompleteTimeout.equals(other.mIncompleteTimeout))
      return false;
    if (mMaxNBest == null) {
      if (other.mMaxNBest != null)
        return false;
    } else if (!mMaxNBest.equals(other.mMaxNBest))
      return false;
    if (mMaxSpeechTimeout == null) {
      if (other.mMaxSpeechTimeout != null)
        return false;
    } else if (!mMaxSpeechTimeout.equals(other.mMaxSpeechTimeout))
      return false;
    if (mSensitivity == null) {
      if (other.mSensitivity != null)
        return false;
    } else if (!mSensitivity.equals(other.mSensitivity))
      return false;
    if (mSpeedVersusAccuracy == null) {
      if (other.mSpeedVersusAccuracy != null)
        return false;
    } else if (!mSpeedVersusAccuracy.equals(other.mSpeedVersusAccuracy))
      return false;
    return true;
  }
