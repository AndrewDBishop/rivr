...
/**
 * Terminates a {@link VoiceXmlDialogue} with a submit, sending information to the server and
 * leaving control to the document returned by the request. Submit can be performed with a
 * <code>GET</code> or a <code>POST</code>.
 *
 * @author Nu Echo Inc.
 ...
 * @see SubmitMethod
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml5.3.8">https://www.w3.org/TR/voicexml20/#dml5.3.8</a>
 */
public class Submit extends VoiceXmlLastTurn {
  ...
  public boolean equals(Object obj) {
    ...
    if (mMediaEncodingType == null) {
      if (other.mMediaEncodingType != null)
        return false;
    } else if (!mMediaEncodingType.equals(other.mMediaEncodingType))
      return false;
    ...
    if (mUri == null) {
      ...
      return false;
    if (mVariables == null) {
      if (other.mVariables != null)
        return false;
    } else if (!mVariables.equals(other.mVariables))
      return false;
    return true;
  }
