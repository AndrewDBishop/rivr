 ...
 * <li>load the <code>rivr.js</code> script which contains the necessary JavaScript methods for
 * result manipulation</li>
 * </ul>
 *
 * @author Nu Echo Inc.
 */
public class DefaultVoiceXmlRootDocumentFactory implements VoiceXmlRootDocumentFactory {
  ...
  public Document getDocument(HttpServletRequest request) {
    ...
    scriptElement.setAttribute(SRC_ATTRIBUTE,
        contextPath + servletPath + VoiceXmlDialogueServlet.RIVR_SCRIPT);
