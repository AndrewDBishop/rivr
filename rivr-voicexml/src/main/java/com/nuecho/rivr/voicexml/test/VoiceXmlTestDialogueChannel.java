...
/**
 * Implementation of {@link VoiceXmlDialogueChannel} intended for unit testing. This class allows a
 * unit test method to be the controller of the dialogue channel by simulating results from the
 * VoiceXML platform (i.e. DTMF recognition, events, recording, etc).
 * <p>
 * In addition to all methods of {@link TestDialogueChannel}, this class adds VoiceXML-related
 * functions.
 *
 * @author Nu Echo Inc.
 */
public class VoiceXmlTestDialogueChannel extends
  ...
  public final Interaction getLastInteraction() {
    ...
    if (lastOutputTurn instanceof Interaction)
      return (Interaction) getLastStepAsOutputTurn();
    throw new AssertionError(
        "Last output turn was not an interaction. Last step=" + lastOutputTurn);
  }

  public final Step<VoiceXmlOutputTurn, VoiceXmlLastTurn> processDtmfRecognition(
      String dtmfString) {
  ...
  public final Step<VoiceXmlOutputTurn, VoiceXmlLastTurn> processDtmfRecognition(String dtmfString,
      JsonValue interpretation, MarkInfo markInfo) {
  ...
  public final Step<VoiceXmlOutputTurn, VoiceXmlLastTurn> processRecognition(
      JsonArray recognitionResult) {
  ...
  public final Step<VoiceXmlOutputTurn, VoiceXmlLastTurn> processRecording(
  ...
  public final Step<VoiceXmlOutputTurn, VoiceXmlLastTurn> processTransferResult(
      TransferStatusInfo transferStatusInfo) {
    VoiceXmlInputTurn inputTurn = new VoiceXmlInputTurn();
