...
/**
 * A {@link Recording} represents the description of a recording final phase of an interaction.
 * <p>
 * It may have an optional {@link DtmfRecognition} to recognize DTMF input while recording. A DTMF
 * input matching one of the {@link DtmfRecognition} grammar will terminate the recording and place
 * the recording in a variable.
 *
 * @author Nu Echo Inc.
 * @see DtmfRecognition
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml2.3.6">https://www.w3.org/TR/voicexml20/#dml2.3.6</a>
 */
public final class Recording implements JsonSerializable {
  ...
  private static final String CLIENT_SIDE_ASSIGNATION_DESTINATION_PROPERTY =
  ...
  /**
   * @param dtmfRecognition The {@link DtmfRecognition} used to interrupt the recording.
  ...
  /**
   * @param beep If true, a tone is emitted just prior to recording. <code>null</code> to use the
  ...
  /**
   * @param maximumTime The maximum duration to record. <code>null</code> to use the VoiceXML
   *        platform default.
   */
  ...
  /**
   * @param finalSilence The interval of silence that indicates end of speech. <code>null</code> to
  ...
  /**
   * @param type The media format of the resulting recording. <code>null</code> to use the VoiceXML
   *        platform default.
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dmlAAudioFormats">https://www.w3.org/TR/voicexml20/#dmlAAudioFormats</a>
   */
  ...
  /**
   * @param clientSideAssignationDestination The variable where the recording will be stored.
   */
  ...
  /**
   * @param dtmfTerm If true, any DTMF keypress not matched by an active grammar will be treated as
   *        a match of an active local DTMF grammar. <code>null</code> to use the VoiceXML platform
   *        default
   */
  ...
  /**
   * @param postAudioToServer If true, recording will be posted to server and made available in the
   *        <code>file</code> property of the {@link RecordingInfo}.
   */
  ...
  public JsonValue asJson() {
    ...
    JsonUtils.add(builder, CLIENT_SIDE_ASSIGNATION_DESTINATION_PROPERTY,
        mClientSideAssignationDestination);
  ...
  public int hashCode() {
    ...
    result = prime * result + ((mClientSideAssignationDestination == null) ? 0
        : mClientSideAssignationDestination.hashCode());
    result = prime * result + ((mDtmfTerm == null) ? 0 : mDtmfTerm.hashCode());
    result =
        prime * result + ((mDtmfTermRecognition == null) ? 0 : mDtmfTermRecognition.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (mBeep == null) {
      if (other.mBeep != null)
        return false;
    } else if (!mBeep.equals(other.mBeep))
      return false;
    if (mClientSideAssignationDestination == null) {
      if (other.mClientSideAssignationDestination != null)
        return false;
    } else if (!mClientSideAssignationDestination.equals(other.mClientSideAssignationDestination))
      return false;
    if (mDtmfTerm == null) {
      if (other.mDtmfTerm != null)
        return false;
    } else if (!mDtmfTerm.equals(other.mDtmfTerm))
      return false;
    if (mDtmfTermRecognition == null) {
      if (other.mDtmfTermRecognition != null)
        return false;
    } else if (!mDtmfTermRecognition.equals(other.mDtmfTermRecognition))
      return false;
    if (mFinalSilence == null) {
      if (other.mFinalSilence != null)
        return false;
    } else if (!mFinalSilence.equals(other.mFinalSilence))
      return false;
    if (mMaximumTime == null) {
      ...
      return false;
    if (mPostAudioToServer != other.mPostAudioToServer)
      return false;
    if (mType == null) {
      if (other.mType != null)
        return false;
