...
/**
 * An {@link InlineXmlGrammar} represents an XML source grammar inlined in the VoiceXML document.
 *
 * @author Nu Echo Inc.
 */
public final class InlineXmlGrammar extends GrammarItem {
  ...
  public boolean equals(Object obj) {
    ...
    if (mDocument == null) {
      if (other.mDocument != null)
        return false;
    } else if (!mDocument.equals(other.mDocument))
      return false;
    return true;
  }
}
