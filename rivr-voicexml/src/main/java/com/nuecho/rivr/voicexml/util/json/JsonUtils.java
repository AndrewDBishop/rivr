...
public final class JsonUtils {
  ...
  public static void addDurationProperty(JsonObjectBuilder builder, String propertyName,
      Duration duration) {
    if (duration == null) {
  ...
  public static void addBooleanProperty(JsonObjectBuilder builder, String propertyName,
      Boolean value) {
    if (value == null) {
      builder.addNull(propertyName);
    } else {
  ...
  public static void addXmlNodeProperty(JsonObjectBuilder builder, String propertName, String item,
      Node node) {
    try {
      builder.add(propertName, DomUtils.writeToString(node));
    } catch (IOException exception) {
      builder.add(propertName, "Exception occurred during serialization of " + item + ": "
          + StringUtils.getAllMessages(exception));
    }
  }

  public static void addNumberProperty(JsonObjectBuilder builder, String propertyName,
      Number number) {
    if (number == null) {
      builder.addNull(propertyName);
    } else {
  ...
  public static void add(JsonObjectBuilder builder, String property,
      JsonArrayBuilder builderToAdd) {
  ...
  public static void add(JsonObjectBuilder builder, String property,
      JsonObjectBuilder builderToAdd) {
    if (builderToAdd == null) {
      builder.addNull(property);
    } else {
      builder.add(property, builderToAdd);
