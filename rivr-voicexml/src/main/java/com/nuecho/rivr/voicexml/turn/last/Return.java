...
/**
 * Terminates a {@link VoiceXmlDialogue} with a return, transferring the control back to the calling
 * dialogue. A list of variables or an event can be returned. Must be used it the
 * {@link VoiceXmlDialogue} was called using a {@link SubdialogueCall}.
 *
 * @author Nu Echo Inc.
 ...
 * @see SubdialogueCall
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml5.3.10">https://www.w3.org/TR/voicexml20/#dml5.3.10</a>
 */
public class Return extends VoiceXmlLastTurn {
  ...
  public boolean equals(Object obj) {
    ...
    if (mEventMessage == null) {
      if (other.mEventMessage != null)
        return false;
    } else if (!mEventMessage.equals(other.mEventMessage))
      return false;
    if (mEventName == null) {
      if (other.mEventName != null)
        return false;
    } else if (!mEventName.equals(other.mEventName))
      return false;
    if (mVariables == null) {
