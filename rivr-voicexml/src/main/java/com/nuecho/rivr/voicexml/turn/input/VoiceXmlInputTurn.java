...
/**
 * The result of an interaction with the platform, it may contains one or many of the following: a
 * recognition result, a recording, VoiceXml events, a transfer status, a script result, uploaded
 * files.
 *
 * @author Nu Echo Inc.
 * @see RecognitionInfo
  ...
  public boolean equals(Object obj) {
    ...
    if (mFiles == null) {
      if (other.mFiles != null)
        return false;
    } else if (!mFiles.equals(other.mFiles))
      return false;
    if (mJsonValue == null) {
      if (other.mJsonValue != null)
        return false;
    } else if (!mJsonValue.equals(other.mJsonValue))
      return false;
    if (mRecognitionInfo == null) {
      if (other.mRecognitionInfo != null)
        return false;
    } else if (!mRecognitionInfo.equals(other.mRecognitionInfo))
      return false;
    if (mRecordingInfo == null) {
      if (other.mRecordingInfo != null)
        return false;
    } else if (!mRecordingInfo.equals(other.mRecordingInfo))
      return false;
    if (mTransferResult == null) {
      if (other.mTransferResult != null)
        return false;
    } else if (!mTransferResult.equals(other.mTransferResult))
      return false;
    return true;
  }
