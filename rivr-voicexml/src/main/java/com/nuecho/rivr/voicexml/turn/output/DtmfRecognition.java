...
/**
 * A {@link DtmfRecognition} represents the DTMF part of an interaction phase recognition
 * configuration. It is composed of a list of DTMF {@link GrammarItem} and optional properties
 * (inter-digit timeout, term timeout, term char).
 *
 * @author Nu Echo Inc.
 */
public final class DtmfRecognition extends Recognition {
  ...
  /**
   * @param interDigitTimeout The inter-digit timeout value to use when recognizing DTMF input.
   *        <code>null</code> to use the VoiceXML platform default.
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3.3">https://www.w3.org/TR/voicexml20/#dml6.3.3</a>
   */
  ...
  /**
   * @param termTimeout The terminating timeout to use when recognizing DTMF input.
   *        <code>null</code> to use the VoiceXML platform default
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3.3">https://www.w3.org/TR/voicexml20/#dml6.3.3</a>
   */
  ...
  /**
   * @param termChar The terminating DTMF character for DTMF input recognition. Must be empty or a
   *        single character. <code>null</code> to use the VoiceXML platform default
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3.3">https://www.w3.org/TR/voicexml20/#dml6.3.3</a>
   */
  public void setTermChar(String termChar) {
    if (termChar != null) {
      Assert.ensure(termChar.equals("") || termChar.length() == 1,
          "Termchar must be empty or single character");
    }
  ...
  public boolean equals(Object obj) {
    ...
    if (mInterDigitTimeout == null) {
      if (other.mInterDigitTimeout != null)
        return false;
    } else if (!mInterDigitTimeout.equals(other.mInterDigitTimeout))
      return false;
    if (mTermChar == null) {
      if (other.mTermChar != null)
        return false;
    } else if (!mTermChar.equals(other.mTermChar))
      return false;
    if (mTermTimeout == null) {
      if (other.mTermTimeout != null)
        return false;
    } else if (!mTermTimeout.equals(other.mTermTimeout))
      return false;
    return true;
  }
