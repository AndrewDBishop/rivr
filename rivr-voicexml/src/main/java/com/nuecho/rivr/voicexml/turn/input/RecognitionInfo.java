...
/**
 * {@link RecognitionInfo} contains a JSON representation of the VoiceXml recognition result
 * (application.lastresult$) and optionally a {@link MarkInfo} containing information about the last
 * {@link Mark} encountered before the recognition occurred.
 *
 * @author Nu Echo Inc.
 * @see MarkInfo
 * @see Mark
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml5.1.5">https://www.w3.org/TR/voicexml20/#dml5.1.5</a>
 */
public final class RecognitionInfo implements JsonSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (mMarkInfo == null) {
      if (other.mMarkInfo != null)
        return false;
    } else if (!mMarkInfo.equals(other.mMarkInfo))
      return false;
    if (mRecognitionResult == null) {
      if (other.mRecognitionResult != null)
        return false;
    } else if (!mRecognitionResult.equals(other.mRecognitionResult))
      return false;
    return true;
  }
}
