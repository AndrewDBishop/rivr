...
public abstract class Recognition implements JsonSerializable {
   ...
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml6.3">https://www.w3.org/TR/voicexml20/#dml6.3</a>
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (mGrammarItems == null) {
      if (other.mGrammarItems != null)
        return false;
    } else if (!mGrammarItems.equals(other.mGrammarItems))
      return false;
    if (mProperties == null) {
