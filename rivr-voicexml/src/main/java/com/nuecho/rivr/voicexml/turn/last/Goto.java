...
/**
 * Terminates a {@link VoiceXmlDialogue} with a goto, transferring the control to another
 * application specified with a URI.
 *
 * @author Nu Echo Inc.
 * @see VoiceXmlDialogue
 * @see LastTurn
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml5.3.7">https://www.w3.org/TR/voicexml20/#dml5.3.7</a>
 */
