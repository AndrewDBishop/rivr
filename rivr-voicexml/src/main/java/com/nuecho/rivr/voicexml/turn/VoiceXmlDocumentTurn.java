 ...
 * {@link VoiceXmlDocumentTurn} has a <code>name</code> and a list (possibly empty) of
 * {@link VoiceXmlDocumentAdapter}.
 *
 * @author Nu Echo Inc.
 */
public abstract class VoiceXmlDocumentTurn implements JsonSerializable {
   ...
   *
   * @param builder A {@link JsonObjectBuilder} that can be used to create the top level JSON
   *        properties
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (mAdapters == null) {
      if (other.mAdapters != null)
        return false;
    } else if (!mAdapters.equals(other.mAdapters))
      return false;
    if (mName == null) {
      if (other.mName != null)
        return false;
