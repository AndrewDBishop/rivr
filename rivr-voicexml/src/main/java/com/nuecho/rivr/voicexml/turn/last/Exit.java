...
/**
 * Terminates a {@link VoiceXmlDialogue} with an exit, returning the control to the platform.
 * Additional information may be returned with an expression of a list of variables.
 *
 * @author Nu Echo Inc.
 * @see VoiceXmlDialogue
 * @see LastTurn
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml5.3.9">https://www.w3.org/TR/voicexml20/#dml5.3.9</a>
 */
