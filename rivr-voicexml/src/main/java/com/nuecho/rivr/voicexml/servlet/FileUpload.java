...
/**
 * HTTP-uploaded file via <code>multipart/form-data</code>, typically the audio file of a recording.
 * This class contains the content type, the headers and the data (ie. a byte array).
 *
 * @author Nu Echo Inc.
 */
public final class FileUpload implements JsonSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (mContentType == null) {
      if (other.mContentType != null)
        return false;
    } else if (!mContentType.equals(other.mContentType))
      return false;
