...
/**
 * This abstract class is the superclass of all classes representing a grammar element in the
 * dialogue. It is not intended to be subclassed.
 *
 * @author Nu Echo Inc.
 ...
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml3.1">https://www.w3.org/TR/voicexml20/#dml3.1</a>
 */
public abstract class GrammarItem implements JsonSerializable {
  ...
  /**
   * @param weight The relative weight of this grammar. <code>null</code> to use the VoiceXML
   *        platform default
   * @see <a href=
   *      "https://www.w3.org/TR/voicexml20/#dml3.1.1.3">https://www.w3.org/TR/voicexml20/#dml3.1.1.3</a>
   */
  ...
  /**
   * @param mediaType The preferred media type for this grammar. <code>null</code> to use the
  ...
  public boolean equals(Object obj) {
    ...
    if (mMediaType == null) {
      if (other.mMediaType != null)
        return false;
    } else if (!mMediaType.equals(other.mMediaType))
      return false;
    if (mWeight == null) {
