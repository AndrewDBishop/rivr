...
/**
 * A {@link SupervisedTransfer} is a {@link Transfer} where the outcome is monitored and where a
 * transfer failure can be handled gracefully.
 * <p>
...
public abstract class SupervisedTransfer extends Transfer {
  ...
  /**
   * @param dtmfRecognition The active DTMF recognition configuration during the transfer.
   */
  ...
  /**
   * @param speechRecognition The active speech recognition configuration during the transfer.
   */
  ...
  /**
   * @param transferAudio The location (URI or path) of audio source to play while the transfer
  ...
  /**
   * @param connectTimeout The time to wait while trying to connect the call before returning with
   *        {@link TransferStatus#NO_ANSWER}. <code>null</code> to use the VoiceXML platform
   *        default.
   */
  ...
  /**
   * Builder used to ease the creation of instances of {@link SupervisedTransfer}
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (mConnectTimeout == null) {
      if (other.mConnectTimeout != null)
        return false;
    } else if (!mConnectTimeout.equals(other.mConnectTimeout))
      return false;
    ...
    if (mTransferAudio == null) {
      if (other.mTransferAudio != null)
        return false;
    } else if (!mTransferAudio.equals(other.mTransferAudio))
      return false;
    return true;
  }
