...
/**
 * An {@link InlineStringGrammar} represents a text source grammar inlined in the VoiceXML document.
 *
 * @author Nu Echo Inc.
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml20/#dml3.1.1.4">https://www.w3.org/TR/voicexml20/#dml3.1.1.4</a>
 */
public final class InlineStringGrammar extends GrammarItem {
  ...
  /**
   * @param version The version of the grammar.<code>null</code> to use the VoiceXML platform
   *        default.
   */
  ...
  /**
   * @param language The language identifier of the grammar. For example, "fr-CA" for Canadian
   *        French. <code>null</code> to use the VoiceXML platform default.
   */
  ...
  /**
   * @param root The name of the rule that will act as the root rule. <code>null</code> to use the
  ...
  /**
   * @param tagFormat The tag content format for all tags within the grammar. <code>null</code> to
  ...
  /**
   * @param base The base URI from which relative URIs in the grammar are resolved.
  ...
  public boolean equals(Object obj) {
    ...
    if (mRoot == null) {
      if (other.mRoot != null)
        return false;
    } else if (!mRoot.equals(other.mRoot))
      return false;
    if (mSource == null) {
      ...
      return false;
    if (mTagFormat == null) {
      if (other.mTagFormat != null)
        return false;
    } else if (!mTagFormat.equals(other.mTagFormat))
      return false;
    if (mVersion == null) {
