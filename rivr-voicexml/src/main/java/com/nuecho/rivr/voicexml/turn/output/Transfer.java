 ...
 * @see <a href=
 *      "https://www.w3.org/TR/voicexml21/#sec-transfer">https://www.w3.org/TR/voicexml21/#sec-transfer</a>
 */
public abstract class Transfer extends VoiceXmlOutputTurn {
  ...
  private static final String APPLICATION_TO_APPLICATION_INFORMATION_PROPERTY =
      "applicationToApplicationInformation";
  ...
  /**
   * @param applicationToApplicationInformation A string containing data sent to an application on
   *        the far-end, available in the session variable session.connection.aai.
   */
  public final void setApplicationToApplicationInformation(
      String applicationToApplicationInformation) {
   ...
   * @throws VoiceXmlDocumentRenderingException when an error occurs while rendering the VoiceXml
   *         document
   */
  ...
  protected void addTurnProperties(JsonObjectBuilder builder) {
    ...
    JsonUtils.add(builder, APPLICATION_TO_APPLICATION_INFORMATION_PROPERTY,
  ...
  protected void fillVoiceXmlDocument(Document document, Element formElement,
    ...
    String script = RIVR_SCOPE_OBJECT + ".addTransferResult(" + TRANSFER_FORM_ITEM_NAME + ", "
  ...
  public int hashCode() {
    ...
    result = prime * result + ((mApplicationToApplicationInformation == null) ? 0
  ...
  public boolean equals(Object obj) {
    ...
    if (mApplicationToApplicationInformation == null) {
      if (other.mApplicationToApplicationInformation != null)
        return false;
    } else if (!mApplicationToApplicationInformation
        .equals(other.mApplicationToApplicationInformation))
      return false;
